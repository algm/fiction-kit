...
OUTLINE_INDEX='$story_dir/outline/index.md'
OUTLINE_ACTS='$story_dir/outline/acts.md'
OUTLINE_CHAPTERS='$story_dir/outline/chapters.md'
OUTLINE_ARCS='$story_dir/outline/arcs.md'
SCENES='$story_dir/scenes.md'
SCENES_DIR='$story_dir/scenes'
SCENES_INDEX='$story_dir/scenes/index.md'
